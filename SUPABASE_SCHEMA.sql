...
-- ============================================================================
-- 6. TABELA: usuarios
-- Perfil complementar ao Supabase Auth (nome/apelido/url_imagem)
-- ============================================================================
...
-- Política de leitura para usuários autenticados em usuarios
CREATE POLICY "usuarios_read_auth" ON usuarios
  FOR SELECT
  TO authenticated
  USING (true);
...
-- Política de inserção para usuários autenticados em usuarios
...
-- Política de atualização para usuários autenticados em usuarios
